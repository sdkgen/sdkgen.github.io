...
- Chrome: [behind a flag, released on version 66](https://www.chromestatus.com/feature/6251293127475200)
- Firefox: [disabled by default, released on version 65](https://bugzilla.mozilla.org/show_bug.cgi?id=1434137)
- NodeJS: [released on version 12](https://github.com/nodejs/node/pull/23284)
- Edge: Unknown
- Safari: Unknown
- Nginx: Unknown
...
1. gRPC uses HTTP/2 for its transport layer, which means it is unable to provide client-side streams on the Web. It has the very same limitations of the first implementation.
