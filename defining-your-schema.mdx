...
* `cnpj` - companies document number.

## Compound types

To compose types into more complex ones, sdkgen provides a typescript-like syntax:
...
// Sending arguments on path adn querystring.
